...
The supplicant notifies that after the first connection, he got from the certificate "tod=2". However, it still connects to the ROGUE AP.
No OTD TOFU Policy is applied.
