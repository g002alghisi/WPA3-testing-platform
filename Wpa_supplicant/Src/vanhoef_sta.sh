...
WPA_SUPPLICANT_WPA2_CONF_PATH="../Conf/Vanhoef/wpa_supplicant_wpa2.conf"
WPA_SUPPLICANT_WPA3_CONF_PATH="../Conf/Vanhoef/wpa_supplicant_wpa3.conf"
WPA_SUPPLICANT_WPA3_PK_CONF_PATH="../Conf/Vanhoef/wpa_supplicant_wpa3_pk.conf"
WPA_SUPPLICANT_CLI_CONF_PATH="../Conf/Vanhoef/wpa_supplicant_cli.conf"
