...
/* My additions to select the SAE-PK mode from MenuConfig */
...
/* My additions to set Transition Disable from MenuConfig */
...
void wifi_init_sta(void)
{
    ...
    wifi_config_t wifi_config = {
        .sta = {
            ...
            /* My additions to handle SAE-PK mode and Transition Disable from MenuConfig */
