...
HOSTAPD_WPA2_CONF_PATH="../Conf/Vanhoef/hostapd_wpa2.conf"
HOSTAPD_WPA3_CONF_PATH="../Conf/Vanhoef/hostapd_wpa3.conf"
HOSTAPD_WPA3_PK_CONF_PATH="../Conf/Vanhoef/hostapd_wpa3_pk.conf"
...
ap_run() {
    ...
    ap_print_info
    echo ""
    sudo /home/alghisi-vm/Downloads/Vanhoef_hostapd/hostap-wpa3/hostapd/hostapd "$hostapd_config_file" -d
